...
namespace Who_want_to_be_a_m2
{
    class Game
    {
        ...
        {
            string rules = "пт. 1 - для начала игры вы должны внести свое имя; "+Environment.NewLine+
                           "пт. 2 - после начала игры вам будет предложен ограниченный перечень вопросов по очереди;"+Environment.NewLine + 
                           "пт. 3 - для каждого вопроса предоставляется 4 варианта ответа;" + Environment.NewLine +
                           "пт. 4 - для ответа на вопрос необходимо ввести номер в числовом представлении, н.п. '1';" + Environment.NewLine + 
                           "пт. 5 - при выборе верного ответа на вопрос выйгрыш приумножается х 2, по выбору пользователя "+Environment.NewLine+
                           ...
                           "пт. 6 - при выборе не верного ответа на вопрос, игра окончена, выйгрыш = 0;" + Environment.NewLine +
